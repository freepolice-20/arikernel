import { runSimulation, generateReport, runInteractive, ATTACK_TYPES, DEFAULT_AUDIT_DB } from '@arikernel/attack-sim';
...
export async function runSimulate(policyPath?: string, attackType?: string, dbPath?: string): Promise<void> {
